...
function setup() {
  ...
  pendulum1 = new Pendulum(400, 450, "#00b0ff");
  ...
  sling1 = new Sling(pendulum1.body, { x: 220, y: 100 });
  sling2 = new Sling(pendulum2.body, { x: 280, y: 100 });
  sling3 = new Sling(pendulum3.body, { x: 340, y: 100 });
  sling4 = new Sling(pendulum4.body, { x: 400, y: 100 });
  sling5 = new Sling(pendulum5.body, { x: 460, y: 100 });
}
